...
<head>
    <meta charset="utf-8">
    <title>Surat Kontrak Probation — {{ $employee->full_name }}</title>
    <style>
...
<body>
    <div class="header">
        <h1>Surat Perjanjian Kerja — Masa Probation</h1>
    ...
    <div class="content">
        ...
        <ol>
            <li>Karyawan dalam masa probation wajib mengikuti seluruh peraturan dan tata tertib perusahaan.</li>
            <li>Masa probation berlangsung selama <strong>{{ $employee->employmentType?->duration_months ?? 3 }} bulan</strong> terhitung sejak tanggal mulai kerja.</li>
            <li>Selama masa probation, karyawan <strong>tidak berhak atas cuti tahunan</strong>. Izin sakit dan izin tanpa gaji tetap dapat diajukan.</li>
            <li>Selama masa probation, karyawan <strong>tidak termasuk dalam program BPJS</strong> perusahaan.</li>
            <li>Evaluasi kinerja akan dilakukan pada akhir masa probation untuk menentukan kelanjutan hubungan kerja.</li>
            <li>Perusahaan maupun karyawan berhak mengakhiri hubungan kerja selama masa probation dengan pemberitahuan 7 hari sebelumnya.</li>
        </ol>

        <div class="highlight">
            <p><strong>Kompensasi:</strong> Rp {{ number_format((float) $employee->basic_salary, 0, ',', '.') }} / bulan</p>
            <p><strong>BPJS:</strong> Tidak berlaku selama masa probation</p>
            <p><strong>Cuti Tahunan:</strong> Tidak berlaku selama masa probation</p>
        </div>
    </div>
    ...
    <p class="note">
        Dokumen ini dihasilkan otomatis oleh sistem HRIS dan sah sebagai lampiran perjanjian kerja.
    </p>
</body>
</html>
